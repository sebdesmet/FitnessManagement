                ...
                <div class="col-xs-12 col-sm-offset-3 col-sm-6">
                    <div class="panel panel-default">
                        ...
                        <ul class="list-group" id="contact-list">
                            <li class="list-group-item" id="user1">
                                <div class="col-xs-12 col-sm-3">
                                    <img src="http://api.randomuser.me/portraits/men/49.jpg" alt="Scott Stevens" class="img-responsive img-circle" />
                                </div>
                                <div class="col-xs-12 col-sm-9">
                                    <span class="name">Scott Stevens</span><button type="button" class="btn btn-success" id="btn1">Ajouter</button><br/>
                                    <span class="glyphicon glyphicon-map-marker text-muted c-info" data-toggle="tooltip" title="Localisation"></span>
                                    <span>LOOOOOL</span><br>
